...
test("form shows success message on submit with form details", () => {
    ...
    fireEvent.change(firstInput, {target: { value: "Juan"}});
    fireEvent.change(lastInput, {target: { value: "Hernandez"}});
    fireEvent.change(addressInput, {target: { value: "123 elm street"}}); 
    fireEvent.change(cityInput, {target: { value: "Downey"}});
    fireEvent.change(stateInput, {target: { value: "CA"}});
    fireEvent.change(zipInput, {target: { value: "90242"}});
